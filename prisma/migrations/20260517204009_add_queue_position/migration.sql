...
INSERT INTO "new_Order" ("adminNotes", "colorId", "createdAt", "estimatedDelivery", "fileName", "filePath", "id", "materialId", "price", "printTimeEstimated", "receiptPath", "shippingMethod", "status", "updatedAt", "userId") SELECT "adminNotes", "colorId", "createdAt", "estimatedDelivery", "fileName", "filePath", "id", "materialId", "price", "printTimeEstimated", "receiptPath", "shippingMethod", "status", "updatedAt", "userId" FROM "Order";
DROP TABLE "Order";
